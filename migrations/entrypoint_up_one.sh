...
goose -dir ./migrations postgres "user=$STAFF_SERVICE_POSTGRES_USER password=$STAFF_SERVICE_POSTGRES_PASSWORD dbname=$STAFF_SERVICE_POSTGRES_DB host=$STAFF_SERVICE_POSTGRES_HOST port=$STAFF_SERVICE_POSTGRES_PORT sslmode=disable" up 1